...
#globalvar MPD_MINALLOC , <mpd_ssize_t>
...
#ccall mpd_qcopy_negate , Ptr <mpd_t> -> Ptr <mpd_t> -> Ptr <uint32_t> -> IO CInt
...
#ccall mpd_qshiftl , Ptr <mpd_t> -> Ptr <mpd_t> -> <mpd_ssize_t> -> Ptr <uint32_t> -> IO CInt
#ccall mpd_qshiftr , Ptr <mpd_t> -> Ptr <mpd_t> -> <mpd_ssize_t> -> Ptr <uint32_t> -> IO CULong
...
#ccall mpd_qshiftn , Ptr <mpd_t> -> Ptr <mpd_t> -> CInt -> Ptr <mpd_context_t> -> Ptr <uint32_t> -> IO ()
...
#ccall mpd_sizeinbase , Ptr <mpd_t> -> <uint32_t> -> IO CSize
...
#ccall mpd_qexport_u16 , Ptr (Ptr <uint16_t>) -> <size_t> -> <uint32_t> -> Ptr <mpd_t> -> Ptr <uint32_t> -> IO <size_t>
#ccall mpd_qexport_u32 , Ptr (Ptr <uint32_t>) -> CSize -> <uint32_t> -> Ptr <mpd_t> -> Ptr <uint32_t> -> IO <size_t>

--  Signalling functions
-- START HERE
#ccall mpd_format , Ptr <mpd_t> -> CString -> Ptr <mpd_context_t> -> IO CString
#ccall mpd_import_u16 , Ptr <mpd_t> -> Ptr <uint16_t> -> <size_t> -> <uint8_t> -> <uint32_t> -> Ptr <mpd_context_t> -> IO ()
#ccall mpd_import_u32 , Ptr <mpd_t> -> Ptr <uint32_t> -> <size_t> -> <uint8_t> -> <uint32_t> -> Ptr <mpd_context_t> -> IO ()
#ccall mpd_export_u16 , Ptr (Ptr <uint16_t>) -> <size_t> -> <uint32_t> -> Ptr <mpd_t> -> Ptr <mpd_context_t> -> IO <size_t>
...
#ccall mpd_sset_u32 , Ptr <mpd_t> -> <uint32_t> -> Ptr <mpd_context_t> -> IO ()
...
#ccall mpd_set_u64 , Ptr <mpd_t> -> <mpd_uint_t> -> Ptr <mpd_context_t> -> IO ()
...
#ccall mpd_get_u64 , Ptr <mpd_t> -> Ptr <mpd_context_t> -> IO <mpd_uint_t>
...
#ccall mpd_add_u64 , Ptr <mpd_t> -> Ptr <mpd_t> -> <mpd_uint_t> -> Ptr <mpd_context_t> -> IO ()
#ccall mpd_sub_i64 , Ptr <mpd_t> -> Ptr <mpd_t> -> <int64_t> -> Ptr <mpd_context_t> -> IO ()
#ccall mpd_sub_u64 , Ptr <mpd_t> -> Ptr <mpd_t> -> <mpd_uint_t> -> Ptr <mpd_context_t> -> IO ()
#ccall mpd_div_i64 , Ptr <mpd_t> -> Ptr <mpd_t> -> <int64_t> -> Ptr <mpd_context_t> -> IO ()
#ccall mpd_div_u64 , Ptr <mpd_t> -> Ptr <mpd_t> -> <mpd_uint_t> -> Ptr <mpd_context_t> -> IO ()
#ccall mpd_mul_i64 , Ptr <mpd_t> -> Ptr <mpd_t> -> <int64_t> -> Ptr <mpd_context_t> -> IO ()
#ccall mpd_mul_u64 , Ptr <mpd_t> -> Ptr <mpd_t> -> <mpd_uint_t> -> Ptr <mpd_context_t> -> IO ()
...
#ccall mpd_digits_to_size , <mpd_ssize_t> -> IO <mpd_ssize_t>
...
#ccall mpd_sign , Ptr <mpd_t> -> IO <uint8_t>
...
#ccall mpd_trail_zeros , Ptr <mpd_t> -> IO <mpd_ssize_t>
...
#globalvar mpd_mallocfunc , <size_t> -> IO (Ptr ())
#callback funptr_mpd_mallocfunc , <size_t> -> IO (Ptr ())

#globalvar mpd_callocfunc , <size_t> -> <size_t> -> IO (Ptr ())
#callback funptr_mpd_callocfunc , <size_t> -> <size_t> -> IO (Ptr ())

#globalvar mpd_reallocfunc , Ptr () -> <size_t> -> IO (Ptr ())
#callback funptr_mpd_reallocfunc , Ptr () -> <size_t> -> IO (Ptr ())

#globalvar mpd_free , Ptr () -> IO ()
#callback funptr_mpd_free , Ptr () -> IO ()

#ccall mpd_callocfunc_em , <size_t> -> <size_t> -> IO (Ptr ())
#ccall mpd_alloc , <size_t> -> <size_t> -> IO (Ptr ())
#ccall mpd_calloc , <size_t> -> <size_t> -> IO (Ptr ())
#ccall mpd_realloc , Ptr () -> <size_t> -> <size_t> -> Ptr <uint8_t> -> IO (Ptr ())
#ccall mpd_sh_alloc , <size_t> -> <size_t> -> <size_t> -> IO (Ptr ())
#ccall mpd_qnew , IO (Ptr <mpd_t>)
#ccall mpd_new , Ptr <mpd_context_t> -> IO (Ptr <mpd_t>)
#ccall mpd_qnew_size , <mpd_ssize_t> -> IO (Ptr <mpd_t>)
#ccall mpd_del , Ptr <mpd_t> -> IO ()
#ccall mpd_uint_zero , Ptr <mpd_uint_t> -> <size_t> -> IO ()
...
#ccall mpd_resize , Ptr <mpd_t> -> <mpd_ssize_t> -> Ptr <mpd_context_t> -> IO CInt
#ccall mpd_resize_zero , Ptr <mpd_t> -> <mpd_ssize_t> -> Ptr <mpd_context_t> -> IO CInt
